            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="col-auto">
                    ...
                    <select id="search-condition">
                        ...
                        <option value="username">管理员用户名</option>
                    </select>
            ...
            <div class="table-responsive small">
                <table class="table table-striped table-sm" id="myContent">
                    ...
                    <tr>
                        ...
                        <th scope="col">管理员密码</th>
                        <th scope="col">管理员真实姓名</th>
                        <th scope="col">管理员性别</th>
                        <th scope="col">管理员年龄</th>
                        <th scope="col">管理员电话</th>
                        <th scope="col">管理员邮箱</th>
                        <th scope="col">管理员头像</th>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">新建/修改管理员信息</h4>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal" id="uForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="adminName" placeholder="管理员用户名"
                                               name="adminName">
                                        <input type="hidden" id="id" name="id"/>
                                    </div>
                                    <label for="adminPwd" class="col-sm-2 control-label">
                                        管理员密码
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="adminPwd" placeholder="管理员密码"
                                               name="adminPwd">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="realName" placeholder="管理员真实姓名"
                                               name="realName">
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="age" placeholder="管理员年龄"
                                               name="age">
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="telephone" placeholder="管理员电话"
                                               name="telephone">
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    ...
    function getList(pageNum) {
        ...
        $.ajax({
            url: 'http://localhost:4444/admin/allPage.action',
            type: 'GET',
            dataType: 'json',
            data: {
                "pageSize": pageSize,
            ...
            success: function (data) {
                ...
                console.log(data);
                if ((data.code == 1007) && (data.status == 200)) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        (
                            ...
                            "<tr id='tr" + admin.id + "'><td>" + admin.id + "</td><td>"
                            + admin.adminName + "</td><td>"
                            + admin.adminPwd + "</td><td>"
                            + admin.realName + "</td><td>"
                            + admin.sex + "</td><td>"
                            + admin.age + "</td><td>"
                            + admin.telephone + "</td><td>"
                            + admin.email + "</td><td>"
                            + admin.pic + "</td><td>"
                            + admin.remark + "</td><td>" +
                            "<a href='${basePath}/admin/admin/adminEdit.jsp?id=" + admin.id + "' class='btn btn-warning' id='form-update'>编辑</a> </td><td>" +
                            "<a href='javascript:void(0);' class='btn btn-danger' onclick='confirmDelete(" + admin.id + ")'>删除</a></td></tr>"
                        );
                    }
    ...
    $("#search-button").click(function () {
        ...
        if (content === "") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    if ((data.code == 1001) && (data.status == 200)) {
        ...
        } else if (condition === "adminname" && content !== "") {
            // 如果搜索条件有效，根据条件和内容搜索并显示用户信息
            $.ajax({
                url: "http://localhost:4444/admin/findByName.json.action",
                data: {name: content},
                method: "GET",
                success: function (data) {
                    console.log(data);
                    if ((data.code == 1002) && (data.status == 200)) {
                        $("#myContent tbody").empty(); // 清空之前的内容
...
<script>
    ...
    function deleteUser(id) {
        ...
        $.ajax({
            url: "http://localhost:4444/admin/delete.json.action",
            data: {id: id},
            method: "POST",
            success: function (data) {
...
<script>
    ...
    function insert() {
        if (check()) {
            ...
            console.log("insert");
            $.ajax({
                url: 'http://localhost:4444/admin/insert.json.action',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    'adminName': adminName,
                ...
                success: function (data) {
                    ...
                    if (data.code == 1003) {    //比较业务代码是否正确
                        alert(data.msg);    //在页面提示信息
                        if (data.status == 200) {
                            clearForm();    //成功后清除表单
                            window.location.href = "${basePath}/admin/admin/admin.jsp";
                        }
                    } else {
    ...
    function update() {
        if (check()) {
            ...
            $.ajax({
                url: 'http://localhost:4444/admin/update.json.action',
                type: 'POST',
                dataType: 'JSON',
...
<script>
    function ajaxSubmit() {
        ...
        $.ajax({
            url: 'http://localhost:4444/admin/upload.action',
            data: fileForm,
            type: 'post',
            dataType: 'json',
            cache: false,
