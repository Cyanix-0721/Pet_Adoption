...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="sidebarMenuLabel" href="http://localhost:4444/admin/user/user.jsp">宠物领养系统</h5>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2
                             active" aria-current="page" href="${basePath}/admin/user/user.jsp">
                                <svg class="bi">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/admin/admin.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                管理员管理
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/pet/pet.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                宠物管理
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/adoption/adoption.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                领养管理
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/comments/comments.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                评论管理
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/blog/blog.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                团队活动管理
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <!--增加/修改宠物信息 modal start-->
            <div class="modal fade" id="pet-Create-Edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" id="uForm">
                                ...
                                <div class="form-group">
                                    <%--@declare id="pettype"--%><label for="petName" class="col-sm-2 control-label">
                                    宠物名
                                </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="petName" placeholder="宠物名"
                                               name="petName">
                                        <input type="hidden" id="id" name="id"/>
                                    </div>
                                    <label for="petType" class="col-sm-2 control-label">
                                        种类
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="petType" placeholder="种类"
                                               name="petType">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="sex" name="sex">
                                            <option value="雄性" selected>雄性</option>
                                            <option value="雄性">雌性</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="state" name="state">
                                        <option value="0" selected>未被领养</option>
                                        <option value="1">已经被领养</option>
                                    </select>
                                </div>
...
<script>
    ...
    function getList(pageNum) {
        ...
        $.ajax({
            url: 'http://localhost:4444/pet/allPage.action',
            type: 'GET',
            dataType: 'json',
            data: {
                "pageSize": pageSize,
            ...
            success: function (data) {
                ...
                console.log(data);
                if ((data.code == 6008) && (data.status == 200)) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        (
                            ...
                            "<tr id='tr" + pet.id + "'><td>" + pet.id + "</td><td>"
                            + pet.petName + "</td><td>"
                            + pet.petType + "</td><td>"
                            + pet.sex + "</td><td>"
                            + pet.birthday + "</td><td>"
                            ...
                            + pet.state + "</td><td>"
                            + pet.remark + "</td><td>" +
                            "<a href='javascript:void(0);' class='btn btn-warning' data-bs-toggle='modal' data-bs-target='#pet-Create-Edit' id='form-update'>编辑</a> </td><td>" +
                            "<a href='javascript:void(0);' class='btn btn-danger' onclick='confirmDelete(" + pet.id + ")'>删除</a></td></tr>"
                        );
                    }
    ...
    $("#search-button").click(function () {
        ...
        if (content === "") {
            ...
            $.ajax({
                url: "http://localhost:4444/pet/findById.json.action", // 假设是根据用户名搜索，你可以根据实际需要修改这个URL
                data: {id: content},
                method: "GET",
                success: function (data) {
                    console.log(data);
                    if ((data.code == 6001) && (data.status == 200)) {
        ...
        } else if (condition === "petname" && content !== "") {
            // 如果搜索条件有效，根据条件和内容搜索并显示用户信息
            $.ajax({
                url: "http://localhost:4444/pet/findByName.json.action",
                data: {name: content},
                method: "GET",
                success: function (data) {
                    console.log(data);
                    if ((data.code == 6002) && (data.status == 200)) {
                        $("#myContent tbody").empty(); // 清空之前的内容
                        for (var i = 0; i < data.data.length; i++) {
                            var pet = data.data[i];
                            $("#myContent tbody").append
...
<script>
    ...
    function deletePet(id) {
        ...
        $.ajax({
            url: "http://localhost:4444/pet/delete.json.action",
            data: {id: id},
            method: "POST",
            success: function (data) {
...
<%--增加/修改操作--%>
<script>
    <%--表单ID采用小写首字母+Form=>"uForm"需要对应表单元素设定为ID，表单元素的name属性要与后台的参数名一致。--%>
    ...
    function check() {
        ...
        if (isNaN(date) || date < "1998-01-01" || date > "2050-12-31") {
            isCheck = false;
            alert("日期不合法！");
            $("#date").focus();
        }
        ...
        //全部检查通过提交数据，使用ajax进行提交
        if (isCheck) {
            //JQuery函数，用于获取表单数据并将其作为URL编码字符串返回
            console.log($("#uForm").serialize());
            //通过myattribute判断是哪个按钮触发的
            if (document.getElementById("btn-insert").getAttribute("myattribute") === "insert") {
                // 调用增加ajax操作
                $.ajax({
                    url: 'http://localhost:4444/pet/insert.json.action',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        'petName': petName,
                    ...
                    success: function (data) {
                        ...
                        if (data.code == 6004) {    //比较业务代码是否正确
                            alert(data.msg);    //在页面提示信息
                            if (data.status == 200) {
                                //clearForm();    //成功后清除表单
                                window.location.href = "${basePath}/admin/pet/pet.jsp";
                            }
                        } else {
            ...
            } else if (document.getElementById("btn-update").getAttribute("myattribute") === "update") {
                // 调用修改ajax操作
                var dataObject = {
                    'petId': petId,
                    'petName': petName,
                ...
                $.ajax({
                    url: 'http://localhost:4444/pet/update.json.action',
                    type: 'POST',
                    dataType: 'JSON',
...
<script>
    $(function () {
        $('#form-update').click(function () {
            ...
            //根据id从服务器读取数据
            $.ajax({
                url: 'http://localhost:4444/pet/findById.json.action',
                type: 'GET',
                dataType: 'JSON',
                data: {"id": id},
                success: function (data) {
                    if (data.code == 6001) {
                        if (data.status == 200) {
                            ...
                            $("#sex").val(pet.sex);
                            $("#birthday").val(pet.birthday);
                            $("#pic").val(pet.pic);
                            $("#state").val(pet.state);
                            $("#remark").val(pet.remark);
...
<script>
    function ajaxSubmit() {
        ...
        $.ajax({
            url: 'http://localhost:4444/pet/upload.action',
            data: fileForm,
            type: 'post',
            dataType: 'json',
            cache: false,
