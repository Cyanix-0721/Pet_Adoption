        ...
        <script>
            ...
            function check() {
                ...
                if (isCheck) {
                    ...
                    //var pDateLong=new Date(pDate.replace(new RegExp("-","gm"),"/")).getTime();
                    //console.log(pDateLong);
/*                    $.ajax({
...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="${basePath}/admin/user/user.jsp">Home</a></li>
    ...
    <div class="row">
        ...
        <div class="col-8 offset-2">
            <form class="form-horizontal" action="#" method="post" id="uForm" onsubmit="return check()">
