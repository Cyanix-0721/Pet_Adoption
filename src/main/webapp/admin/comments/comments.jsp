            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2"
                               href="${basePath}/admin/comments/comment.jsp">
                                <svg class="bi">
                                    <use xlink:href="#puzzle"/>
                                </svg>
                                评论管理
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="col-auto">
                    ...
                    <select id="search-condition">
                        ...
                        <option value="userId">评论人</option>
                    </select>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">新建/修改用户信息</h4>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal" id="uForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="userId" placeholder="评论名"
                                               name="userId">
                                        <input type="hidden" id="id" name="id"/>
                                    </div>
                                    <label for="petId" class="col-sm-2 control-label">
                                        宠物名
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="petId" placeholder="宠物名"
                                               name="petId">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="content" placeholder="评论内容"
                                               name="content">
                                    </div>
                                    <label for="commentTime" class="col-sm-2 control-label">
                                        评论时间
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="commentTime" placeholder="评论时间"
                                               name="commentTime">
                                    </div>
                                </div>
...
<script>
    ...
    function getList(pageNum) {
        ...
        $.ajax({
            url: 'http://localhost:4444/comments/allPage.action',
            type: 'GET',
            dataType: 'json',
            data: {
                "pageSize": pageSize,
            ...
            success: function (data) {
                ...
                console.log(data);
                if ((data.code == 5006) && (data.status == 200)) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        (
                            ...
                            "<tr id='tr" + comment.id + "'><td>" + comment.id + "</td><td>"
                            + comment.userId + "</td><td>"
                            + comment.petId + "</td><td>"
    ...
    $("#search-button").click(function () {
        ...
        if (content === "") {
            ...
            $.ajax({
                url: "http://localhost:4444/comments/findById.json.action", // 假设是根据用户名搜索，你可以根据实际需要修改这个URL
                data: {id: content},
                method: "GET",
                success: function (data) {
                    console.log(data);
                    if ((data.code == 5001) && (data.status == 200)) {
            ...
            // 如果搜索条件有效，根据条件和内容搜索并显示用户信息
            $.ajax({
                url: "http://localhost:4444/comments/findByName.json.action",
                data: {name: content},
                method: "GET",
                success: function (data) {
                    console.log(data);
                    if ((data.code == 5002) && (data.status == 200)) {
                        $("#myContent tbody").empty(); // 清空之前的内容
...
<script>
    ...
    function deleteUser(id) {
        ...
        $.ajax({
            url: "http://localhost:4444/comments/delete.json.action",
            data: {id: id},
            method: "POST",
            success: function (data) {
...
<script>
    function check() {
        ...
        var petId = $("#petId").val();
        var commentTime = $("#commmentTime").val();
    ...
    function insert() {
        if (check()) {
            ...
            console.log("insert");
            $.ajax({
                url: 'http://localhost:4444/comments/insert.json.action',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    'userId': userId,
    ...
    function update() {
        if (check()) {
            ...
            $.ajax({
                url: 'http://localhost:4444/comments/update.json.action',
                type: 'POST',
                dataType: 'JSON',
