                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        ...
                        <div class="text-center mt-5">
                            <a href="${basePath}/user/reg.jsp" class="btn btn-primary btn-float btn-lg">
                        ...
                        <div class="card bg-primary text-white">
                            <div class="card-body">
                                ...
                                <%--登录表单--%>
                                <form class="form-primary" action="${basePath}/user/login.action" method="post"
