...
<div>
    <div>
        ...
        <div class="animal_me">
            <div class="animal_me1"><img src="${basePath}/static/img/p6.jpg"/> <img
                    src="${basePath}/static/img/p7.jpg"/> <img src="${basePath}/static/img/p8.jpg"/> <img
                    src="${basePath}/static/img/p9.jpg"/> <img src="${basePath}/static/img/p10.jpg"/></div>
            <div class="animal_me2"><p>大家好，我是哼哼。我的特点是可爱的外表和触动人心的叫声。我很喜欢认识朋友，
        ...
        <div class="my_btn">
            ...
            <button class="btn btn-primary btn-lg" id="tianchuan_btn"
                    onclick="location.href='${path}/user/services.jsp'"
