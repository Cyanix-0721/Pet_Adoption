...
<head>
    ...
    <script src="${path}/static/js/user/jquery.comment.js" charset="UTF-8"></script>
</head>
<body>
<div>
<div>
...
<ul class="items">
   ...
   <div class="name">
    ...
    <div class="animal">
        ...
        <div class="animalX2">
            <img src="${path}/static/img/p3.jpg"><span>生日</span><br>
            <p>2023/04/18</p>
        </div>
        </div>
        <div class="group">
            <div class="animalX3">
                <img src="${path}/static/img/p4.jpg"><span>品种</span><br>
                <p>狸花猫</p>
            </div>
            <div class="animalX4">
                <img src="${path}/static/img/p5.jpg"><span>性别</span><br>
                <p>雄性</p>
            </div>
        </div>
...
<div class="animal_me">
    <div class="animal_me1"><img src="${path}/static/img/p6.jpg"/> <img src="/static/img/p7.jpg"/> <img src="/static/img/p8.jpg"/> <img src="/static/img/p9.jpg"/> <img src="/static/img/p10.jpg"/></div>
    <div class="animal_me2"><p>大家好，我是顿顿。我的特点是一竖一折的耳朵和会说话的眼神。我很喜欢认识朋友，
        我已经准备好当你的好朋友，你能带我回家吗?</p></div>
    <div class="animal_me3"><img src="${path}/static/img/p11.jpg" height="100px"/></div>
</div>
<div class="my_btn">
