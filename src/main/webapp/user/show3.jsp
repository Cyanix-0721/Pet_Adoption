...
<div>
    <div>
        ...
        <div class="animal_me">
            <div class="animal_me1"><img src="${path}/static/img/p6.jpg"/> <img src="${basePath}/static/img/p7.jpg"/>
                <img
                        src="${path}/static/img/p8.jpg"/> <img src="${path}/static/img/p9.jpg"/> <img
                        src="${basePath}/static/img/p10.jpg"/></div>
            <div class="animal_me2"><p>大家好，我是紧紧。我的特点是非常非常喜欢粘人。我很喜欢认识朋友，
