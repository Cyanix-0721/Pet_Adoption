...
<div>
    <div>
        ...
        <div class="animal_me">
            <div class="animal_me1"><img src="${basePath}/static/img/p6.jpg"/> <img src="${basePath}/static/img/p7.jpg"/> <img
                    src="${basePath}/static/img/p8.jpg"/> <img src="${basePath}/static/img/p9.jpg"/> <img src="${basePath}/static/img/p10.jpg"/></div>
            <div class="animal_me2"><p>大家好，我是霍霍。我的特点是帅气的外表和飘逸的毛发。我很喜欢认识朋友，
        ...
        <div class="my_btn">
            ...
            <button class="btn btn-primary btn-lg" id="tianchuan_btn"
                    onclick="location.href='${path}/admin/user/services.jsp'"
