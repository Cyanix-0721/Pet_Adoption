...
<ul class="items">
    <li><a href="" ><img class="my-img" src="${basePath}/static/img/1.jpg"></a></li>
    <li><a href="" ><img class="my-img" src="${basePath}/static/img/2.jpg"></a></li>
    <li><a href="" ><img class="my-img" src="${basePath}/static/img/3.jpg"></a></li>
    <li><a href="" ><img class="my-img" src="${basePath}/static/img/4.jpg"></a></li>
</ul>
</div>
   <div class="name">
                <img src="${basePath}/static/img/p1.jpg" height="50px" width="50px">
                <span>我叫 偶偶</span>
            </div>
</center>
    <div class="animal">
        <div class="group">
        <div class="animalX1">
            <img src="${basePath}/static/img/p2.jpg"><span>编号</span><br>
            <p>11</p>
        </div>
        <div class="animalX2">
...
<div class="animal_me">
    <div class="animal_me1"><img src="${basePath}/static/img/p6.jpg"/> <img src="${basePath}/static/img/p7.jpg"/> <img src="/static/img/p8.jpg"/> <img src="/static/img/p9.jpg"/> <img src="/static/img/p10.jpg"/></div>
    <div class="animal_me2"><p>大家好，我是偶偶。我的特点是异于常猫的异瞳。我很喜欢认识朋友，
...
<div class="my_btn">
    ...
    <button class="btn btn-primary btn-lg" id="tianchuan_btn"  onclick="location.href='${path}/admin/user/services.jsp'"
