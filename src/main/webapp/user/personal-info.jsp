        ...
        <div class="settings-wrapper" id="pad-wrapper">
            ...
            <div class="span3 avatar-box">
                <div class="personal-image">
                    <img src="${path}/static/img/a2.png" class="avatar img-circle"/>
                    <p>更新头像</p>
                    <input type="file"/>
                </div>
            </div>
            ...
            <div class="span7 personal-info">
                ...
                <form>
                    ...
                    <div class="field-box">
                        <label>密码:</label>
                        <input type="text" class="span5 inline-input" id="edit_password" placeholder="用户密码"
                               name="userPwd"
                               value="${user.userPwd}"/>
                    </div>
                    <div class="field-box">
                    ...
                    <div class="span6 field-box actions">
                        <input type="button" class="btn-glow primary" id="sub" value="提交修改"/>
                    </div>
                </form>
            </div>
        </div>
